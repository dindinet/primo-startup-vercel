// Header - Updated December 17, 2023
function noop() { }
const identity = x => x;
...
function create_each_block_3(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "nav-item svelte-c85gwn");
...
function create_each_block_2(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "button svelte-c85gwn");
			attr(a, "href", a_href_value = /*link*/ ctx[8].url);
		},
		m(target, anchor) {
			insert_hydration(target, a, anchor);
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(hr, "class", "svelte-c85gwn");
			attr(button, "id", "close");
			attr(button, "aria-label", "Close Navigation");
			attr(button, "class", "svelte-c85gwn");
			attr(nav, "id", "mobile-nav");
			attr(nav, "class", "svelte-c85gwn");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(a, "href", "/");
			attr(a, "class", "logo svelte-c85gwn");
			set_style(a, "--size", style___size);
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(button, "class", "svelte-c85gwn");
			attr(nav, "class", "svelte-c85gwn");
			attr(div0, "class", "desktop-nav svelte-c85gwn");
			attr(div1, "class", "section-container svelte-c85gwn");
			attr(header, "class", "svelte-c85gwn");
		},
		m(target, anchor) {
